...
fig_1 = px.bar(df.groupby(['prod_name','sale_date'], as_index=False)['amt'].sum(), x='sale_date', y='amt', color='prod_name')
...
fig_2 = px.line(df_temp, y="amt_cumsum", x="sale_day", color="sale_month")
